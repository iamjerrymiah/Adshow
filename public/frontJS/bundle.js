...
exports.updatePostAlert = exports.signAlert = exports.showAlert = exports.reviewAlert = exports.logAlert = exports.hideAlert = exports.createAlert = void 0;
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" style=\"text-align: center\">").concat(msg, "</div>");
...
var logAlert = function logAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" style=\"text-align: center\">").concat(msg, "</div>");
...
var signAlert = function signAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" style=\"text-align: center\">").concat(msg, "</div>");
...
var updatePostAlert = function updatePostAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" style=\"text-align: center\">").concat(msg, "</div>");
...
exports.updatePostAlert = updatePostAlert;

var reviewAlert = function reviewAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" style=\"text-align: center\">").concat(msg, "</div>");
...
exports.reviewAlert = reviewAlert;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.logAlert)('success', 'You are successfully logged in!');
          ...
          case 7:
            ...
            (0, _alert.logAlert)('error', 'Incorrect Email or Password!');
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, username, phoneNumber, email, password, passwordConfirm) {
    var res, usernameError, usernameErr;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.signAlert)('success', 'Welcome, You are successfully signed up');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            usernameError = _context.t0.response.data.message;
            usernameErr = usernameError.startsWith('E11000 duplicate key error');

            if (usernameErr) {
              (0, _alert.signAlert)('error', "Please provide a different username! ".concat(username, " is already taken!"));
            } else {
              (0, _alert.signAlert)('error', _context.t0.response.data.message);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createProd.js":[function(require,module,exports) {
"use strict";
...
var createProd = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(headline, category) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.createAlert)('success', 'Select a video or image from next page');
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.createAlert)('error', 'Something went wrong! Try again');
  ...
  return function createProd(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.createProd = createProd;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updatePost.js":[function(require,module,exports) {
"use strict";
...
var updatePost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, postId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.updatePostAlert)('success', 'Post successfully uploaded!');
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.updatePostAlert)('error', _context.t0.response.data.message);
...
var reviewProd = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postId, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/posts/".concat(postId, "/reviews"),
              data: {
                review: review
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.reviewAlert)('success', 'Review uploaded!');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.reviewAlert)('error', 'Something Went Wrong! Try again later.');
            window.setTimeout(function () {
              location.reload();
            }, 700);
  ...
  return function reviewProd(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.reviewProd = reviewProd;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"like.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.liking = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/posts/".concat(postId, "/likes")
            });
...
var postBill = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postId) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.post("/api/v1/posts/checkout-session/".concat(postId)).then(function (res) {
              return res.data;
            }).then(function (_ref2) {
              var url = _ref2.url;
              window.location = url;
  ...
  return function postBill(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.postBill = postBill;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"billboard.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addBillboard = void 0;
...
var addBillboard = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/posts/bill/".concat(postId)
            });
  ...
  return function addBillboard(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.addBillboard = addBillboard;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"reverseBillboard.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reverseBillboard = void 0;
...
var reverseBillboard = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/posts/reverse-bill/".concat(postId)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Successfully removed billboard!');
              window.setTimeout(function () {
                location.assign('/account');
              }, 1000);
            }
  ...
  return function reverseBillboard(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.reverseBillboard = reverseBillboard;
...
var _createProd = require("./createProd");
...
var _reverseBillboard = require("./reverseBillboard");
...
var userDataPhoto = document.querySelector('.form-user-photo');
var userPasswordForm = document.querySelector('.form-password');
var createPostForm = document.querySelector('.form-create');
var updatePostForm = document.querySelector('.update-post-form');
var reviewForm = document.querySelector('.review-form');
var likeBtn = document.getElementById('like-btn');
var logOutBtn = document.getElementById('logout-btn');
var billBtn = document.getElementById('stripe-post');
var addBillBtn = document.getElementById('add-bill');
var reverseBillBtn = document.getElementById('admin-reverse-bill'); //DELEGATION
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  var username = document.getElementById('sig-username').value;
  var phoneNumber = document.getElementById('sig-phoneNumber').value;
  var email = document.getElementById('sig-email').value;
  var password = document.getElementById('sig-password').value;
  var passwordConfirm = document.getElementById('sig-passwordConfirm').value;
  (0, _signup.signup)(name, username, phoneNumber, email, password, passwordConfirm);
});
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout);
if (createPostForm) createPostForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var headline = document.getElementById('postHeadline').value;
  var category = document.getElementById('postCategory').value;
  (0, _createProd.createProd)(headline, category);
});
if (updatePostForm) updatePostForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('photo', document.getElementById('photo').files[0]);
  var postId = e.target.dataset.postId;
  (0, _updatePost.updatePost)(form, postId);
});
if (userDataPhoto) userDataPhoto.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('photo', document.getElementById('photo').files[0]);
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  ...
  var postId = e.target.dataset.postId;
  (0, _review.reviewProd)(postId, review);
});
if (likeBtn) likeBtn.addEventListener('click', function (e) {
  e.target.textContent = '...';
  var postId = e.target.dataset.postId;
  (0, _like.liking)(postId);
  e.target.textContent = 'successfully liked';
});
if (billBtn) billBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...';
  var stripepostId = e.target.dataset.stripepostId;
  (0, _stripe.postBill)(stripepostId);
});
if (addBillBtn) addBillBtn.addEventListener('click', function (e) {
  var postId = e.target.dataset.postId;
  (0, _billboard.addBillboard)(postId);
});
if (reverseBillBtn) reverseBillBtn.addEventListener('click', function (e) {
  var adminbillId = e.target.dataset.adminbillId;
  (0, _reverseBillboard.reverseBillboard)(adminbillId);
});
var alertMessage = document.querySelector('body').dataset.alert;
if (alertMessage) (0, _alert.showAlert)('success', alertMessage, 20); //File Input Functionality
...
var container = document.getElementById('lazyLoadID');
...
function _getPost() {
  _getPost = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var rangeResponse, rangePost, num, postResponse, postData, data;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch('/api/v1/posts/post-length');

          case 3:
            rangeResponse = _context2.sent;
            _context2.next = 6;
            return rangeResponse.json();

          case 6:
            rangePost = _context2.sent;
            num = parseInt(rangePost.length); //transfrom the length to Integer

            _context2.next = 10;
            return fetch("/api/v1/posts/lazyLoad/".concat(getRandomNr(num)));
...
function addDataToDOM(data) {
  ...
  var imgLoop = data.post.posts[0].photo;
  ...
  function imageDiv() {
    if (photoLoop === 'MP4' || photoLoop === 'mp4' || photoLoop === 'MP2' || photoLoop === 'mp2' || photoLoop === 'WEBM' || photoLoop === 'webm' || photoLoop === 'AVI' || photoLoop === 'avi' || photoLoop === 'ogg' || photoLoop === 'wmv' || photoLoop === 'MOV' || photoLoop === 'mov') {
      return "<video src=\"images/posts/".concat(data.post.posts[0].photo, "\" \n          style=\"max-width: 100%; height: 300px;\" autoplay muted></video>\t");
      ...
      return "<img src=\"images/posts/".concat(data.post.posts[0].photo, "\" alt=\"\" \n        class=\"img-fluid\">");
    }
  }
  ...
  if (data.post.posts[0].photo !== 'vitualpost.jpg') {
    postElement.innerHTML = "\n  <div class=\"row g-5\" style=\"margin-top: 5px;\">\n\t\t\t\n\t\t\t\t<div class=\"col-lg-10\" style=\"margin-bottom: -40px; border-bottom: 12px solid rgb(216, 214, 214);\">\n\t\t\t\t\t<div class=\"post-entry d-block small-post-entry-v\">\n\t\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t<a href=\"".concat(data.post.posts[0].slug, "\" class=\"post-author d-flex align-items-center\">\n\t\t\t\t\t\t\t\t<div class=\"author-pic\" style=\"margin-top: 5px;\">\n\t\t\t\t\t\t\t\t\t<img src=\"images/users/").concat(data.post.posts[0].user.photo, "\" alt=\"Image\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"text\">\n\t\t\t\t\t\t\t\t\t<strong style=\"color: #000;\"> @").concat(data.post.posts[0].user.username, "</strong>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<div class=\"post-meta mb-1\">\n\t\t\t\t\t\t\t\t<span class=\"category\">").concat(data.post.posts[0].category, "</span> &mdash;\n\n\t\t\t\t\t\t\t\t<span class=\"date\" style=\"font-size: smaller;\">").concat(data.post.posts[0].createdAt.split('T').shift(), "</span>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t<h6><a href=\"/").concat(data.post.posts[0].slug, "\" style=\"color: rgb(66, 66, 66);\">").concat(data.post.posts[0].headline.split('-_-_-_').shift(), "</a></h6>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"thumbnail\" style=\"background-color: #000; text-align: center;\">\n\t\t\t\t\t\t\n              \t<a href=\"/").concat(data.post.posts[0].slug, "\">\n\t\t\t\t\t\t\t\t").concat(imageDiv(), "\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<ul class=\"admin-list blog-sing\" style=\"height: 60px; background-color: rgb(32, 32, 32);\">     \n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-heart\" aria-hidden=\"true\"></span>\n                ").concat(data.post.posts[0].likes.length, " Likes</a></li>\n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-commenting\" aria-hidden=\"true\"></span>\n\t\t\t\t\t\t\t\t\t").concat(data.post.posts[0].reviews.length, " Comments</a></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n  ");
  }
...
function addDataToDOM2(data) {
  var postElement = document.createElement('div');
  postElement.classList.add('container');
  var imgLoop = data.post.posts[1].photo;
  var photoLoop = imgLoop.split('.').pop();

  function imageDiv() {
    if (photoLoop === 'MP4' || photoLoop === 'mp4' || photoLoop === 'MP2' || photoLoop === 'mp2' || photoLoop === 'WEBM' || photoLoop === 'webm' || photoLoop === 'AVI' || photoLoop === 'avi' || photoLoop === 'ogg' || photoLoop === 'wmv' || photoLoop === 'MOV' || photoLoop === 'mov') {
      return "<video src=\"images/posts/".concat(data.post.posts[1].photo, "\" \n          style=\"max-width: 100%; height: 300px;\" autoplay muted></video>\t");
    } else if (photoLoop === 'jpg' || photoLoop === 'JPG' || photoLoop === 'PNG' || photoLoop === 'png' || photoLoop === 'JPEG' || photoLoop === 'jpeg' || photoLoop === 'GIF' || photoLoop === 'gif' || photoLoop === 'tiff' || photoLoop === 'psd' || photoLoop === 'PDF' || photoLoop === 'pdf') {
      return "<img src=\"images/posts/".concat(data.post.posts[1].photo, "\" alt=\"\" \n        class=\"img-fluid\">");
    }
  }
  ...
  if (data.post.posts[1].photo !== 'vitualpost.jpg') {
    postElement.innerHTML = "\n  <div class=\"row g-5\" style=\"margin-top: 5px;\">\n\t\t\t\n\t\t\t\t<div class=\"col-lg-10\" style=\"margin-bottom: -40px; border-bottom: 12px solid rgb(216, 214, 214);\">\n\t\t\t\t\t<div class=\"post-entry d-block small-post-entry-v\">\n\t\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t<a href=\"".concat(data.post.posts[1].slug, "\" class=\"post-author d-flex align-items-center\">\n\t\t\t\t\t\t\t\t<div class=\"author-pic\" style=\"margin-top: 5px;\">\n\t\t\t\t\t\t\t\t\t<img src=\"images/users/").concat(data.post.posts[1].user.photo, "\" alt=\"Image\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"text\">\n\t\t\t\t\t\t\t\t\t<strong style=\"color: #000;\"> @").concat(data.post.posts[1].user.username, "</strong>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<div class=\"post-meta mb-1\">\n\t\t\t\t\t\t\t\t<span class=\"category\">").concat(data.post.posts[1].category, "</span> &mdash;\n\n\t\t\t\t\t\t\t\t<span class=\"date\" style=\"font-size: smaller;\">").concat(data.post.posts[1].createdAt.split('T').shift(), "</span>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t<h6><a href=\"/").concat(data.post.posts[1].slug, "\" style=\"color: rgb(66, 66, 66);\">").concat(data.post.posts[0].headline.split('-_-_-_').shift(), "</a></h6>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"thumbnail\" style=\"background-color: #000; text-align: center;\">\n\t\t\t\t\t\t\n              \t<a href=\"/").concat(data.post.posts[1].slug, "\">\n\t\t\t\t\t\t\t\t").concat(imageDiv(), "\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<ul class=\"admin-list blog-sing\" style=\"height: 60px; background-color: rgb(32, 32, 32);\">     \n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-heart\" aria-hidden=\"true\"></span>\n                ").concat(data.post.posts[1].likes.length, " Likes</a></li>\n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-commenting\" aria-hidden=\"true\"></span>\n\t\t\t\t\t\t\t\t\t").concat(data.post.posts[1].reviews.length, " Comments</a></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n  ");
  }
...
function addDataToDOM3(data) {
  var postElement = document.createElement('div');
  postElement.classList.add('container');
  var imgLoop = data.post.posts[2].photo;
  var photoLoop = imgLoop.split('.').pop();

  function imageDiv() {
    if (photoLoop === 'MP4' || photoLoop === 'mp4' || photoLoop === 'MP2' || photoLoop === 'mp2' || photoLoop === 'WEBM' || photoLoop === 'webm' || photoLoop === 'AVI' || photoLoop === 'avi' || photoLoop === 'ogg' || photoLoop === 'wmv' || photoLoop === 'MOV' || photoLoop === 'mov') {
      return "<video src=\"images/posts/".concat(data.post.posts[2].photo, "\" \n          style=\"max-width: 100%; height: 300px;\" autoplay muted></video>\t");
    } else if (photoLoop === 'jpg' || photoLoop === 'JPG' || photoLoop === 'PNG' || photoLoop === 'png' || photoLoop === 'JPEG' || photoLoop === 'jpeg' || photoLoop === 'GIF' || photoLoop === 'gif' || photoLoop === 'tiff' || photoLoop === 'psd' || photoLoop === 'PDF' || photoLoop === 'pdf') {
      return "<img src=\"images/posts/".concat(data.post.posts[2].photo, "\" alt=\"\" \n        class=\"img-fluid\">");
    }
  }
  ...
  if (data.post.posts[2].photo !== 'vitualpost.jpg') {
    postElement.innerHTML = "\n  <div class=\"row g-5\" style=\"margin-top: 5px;\">\n\t\t\t\n\t\t\t\t<div class=\"col-lg-10\" style=\"margin-bottom: -40px; border-bottom: 12px solid rgb(216, 214, 214);\">\n\t\t\t\t\t<div class=\"post-entry d-block small-post-entry-v\">\n\t\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t<a href=\"".concat(data.post.posts[2].slug, "\" class=\"post-author d-flex align-items-center\">\n\t\t\t\t\t\t\t\t<div class=\"author-pic\" style=\"margin-top: 5px;\">\n\t\t\t\t\t\t\t\t\t<img src=\"images/users/").concat(data.post.posts[2].user.photo, "\" alt=\"Image\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"text\">\n\t\t\t\t\t\t\t\t\t<strong style=\"color: #000;\"> @").concat(data.post.posts[2].user.username, "</strong>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<div class=\"post-meta mb-1\">\n\t\t\t\t\t\t\t\t<span class=\"category\">").concat(data.post.posts[2].category, "</span> &mdash;\n\n\t\t\t\t\t\t\t\t<span class=\"date\" style=\"font-size: smaller;\">").concat(data.post.posts[2].createdAt.split('T').shift(), "</span>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t<h6><a href=\"/").concat(data.post.posts[2].slug, "\" style=\"color: rgb(66, 66, 66);\">").concat(data.post.posts[2].headline.split('-_-_-_').shift(), "</a></h6>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"thumbnail\" style=\"background-color: #000; text-align: center;\">\n\t\t\t\t\t\t\n              \t<a href=\"/").concat(data.post.posts[2].slug, "\">\n\t\t\t\t\t\t\t\t").concat(imageDiv(), "\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<ul class=\"admin-list blog-sing\" style=\"height: 60px; background-color: rgb(32, 32, 32);\">     \n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-heart\" aria-hidden=\"true\"></span>\n                ").concat(data.post.posts[2].likes.length, " Likes</a></li>\n\t\t\t\t\t\t\t\t<li style=\"margin-top: 15px;\"><a href=\"/<%= post.slug %>\"><span class=\"icon-commenting\" aria-hidden=\"true\"></span>\n\t\t\t\t\t\t\t\t\t").concat(data.post.posts[2].reviews.length, " Comments</a></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n  ");
  }
